...
public class SkyLightPackage implements Parcelable, Serializable {
    ...
    public void addPSavings(Profile userProfile, Customer customer, SkyLightPackage skyLightPackage) {
        String savingCount = "C" + (packageSavings.size() + 1);
        CustomerDailyReport customerSavings = new CustomerDailyReport();
        packageSavings.add(customerSavings);
    }
