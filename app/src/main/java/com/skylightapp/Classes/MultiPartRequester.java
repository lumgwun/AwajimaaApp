...
public class MultiPartRequester {
    ...
    public MultiPartRequester(Activity activity, Map<String, String> map,
                              int serviceCode, AsyncListener asyncTaskCompleteListener) {
        this.map = map;
        ...
        if (UtilsExtra.isNetworkAvailable(activity)) {
            mAsynclistener = (AsyncListener) asyncTaskCompleteListener;
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                ...
                for (String key : map.keySet()) {
                    ...
                    if (key.equalsIgnoreCase(BookingConstant.Params.PICTURE)) {
