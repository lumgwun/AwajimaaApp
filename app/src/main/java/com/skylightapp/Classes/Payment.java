...
public class Payment implements Parcelable,Serializable {
    ...
    public static final String CREATE_PAYMENT_TABLE = "CREATE TABLE IF NOT EXISTS " + PAYMENTS_TABLE + " (" + PAYMENT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + PAYMENT_PROF_ID + " INTEGER , " +
            PAYMENT_CUS_ID + " INTEGER , " + PAYMENT_ADMIN_ID + " INTEGER, " + PAYMENTTYPE + " TEXT, " + PAYMENT_AMOUNT + " FLOAT, " + PAYMENT_DATE + " TEXT, " + PAYMENT_APPROVAL_DATE + " TEXT, " +
    ...
    protected Payment(Parcel in) {
        ...
        amountToWithdraw = in.readDouble();
        ...
        withdrawalBalance = in.readDouble();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeDouble(amountToWithdraw);
        ...
        parcel.writeDouble(withdrawalBalance);
    }
    ...
    private  int profileID, customerID;
    ...
    public Payment(int profileID, int customerID, String typeOfPayment, double amountPaid, Date date, String approver, long code, String acctType, String office, String status) {
        this.profileID = profileID;
        this.customerID = customerID;
        this.paymentType = PAYMENT_TYPE.valueOf(typeOfPayment);
        this.amountToWithdraw = amountPaid;
    ...
    public Payment(String typeOfPayment, double amountPaid, Date date,long code, String acctType, String office, String status) {
        this.paymentType = PAYMENT_TYPE.valueOf(typeOfPayment);
        this.amountToWithdraw = amountPaid;
        this.paymentDate = String.valueOf(date);
        this.paymentCode = code;
    ...
    public Payment(int customerID, String typeOfPayment, double amountPaid, Date date, String status) {
        this.customerID = customerID;
        this.paymentType = PAYMENT_TYPE.valueOf(typeOfPayment);
        this.amountToWithdraw = amountPaid;
        this.paymentDate = String.valueOf(date);
    ...
    public Payment(int reportID, int dbaseID, Date date, String status) {
        this.nr = reportID;
