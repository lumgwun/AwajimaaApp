...
public class TellerReport  implements Serializable, Parcelable {
    ...
    //public static final String TELLER_REPORT_ADMIN = "T_R_AdminName";


    public static final String CREATE_TELLER_REPORT_TABLE = "CREATE TABLE IF NOT EXISTS " + TELLER_REPORT_TABLE + " (" + TELLER_REPORT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + OFFICE_BRANCH_ID + " INTEGER , " + ADMIN_ID + " INTEGER , " + CUSTOMER_TELLER_ID + " INTEGER , " +
            ...
            TELLER_REPORT_ADMIN + " TEXT, " + TELLER_REPORT_MARKETER + " TEXT, " + TELLER_REPORT_APPROVAL_DATE + " DATE," + TELLER_REPORT_STATUS + " TEXT," + "FOREIGN KEY(" + OFFICE_BRANCH_ID  + ") REFERENCES " + OFFICE_BRANCH_TABLE + "(" + OFFICE_BRANCH_ID + ")," +"FOREIGN KEY(" + CUSTOMER_TELLER_ID  + ") REFERENCES " + CUSTOMER_TELLER_TABLE + "(" + CUSTOMER_TELLER_ID + ")," +"FOREIGN KEY(" + ADMIN_ID + ") REFERENCES " + ADMIN_TABLE + "(" + ADMIN_ID + "))";
