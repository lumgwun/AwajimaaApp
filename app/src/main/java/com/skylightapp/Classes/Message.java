...
public class Message implements Serializable, Parcelable {
    ...
    public static final String CREATE_MESSAGE_TABLE = "CREATE TABLE IF NOT EXISTS " + MESSAGE_TABLE + " (" + MESSAGE_PROF_ID + " INTEGER, " + MESSAGE_ID + " INTEGER , " +
            ...
            VIEWED + " INTEGER, " + MESSAGE_BRANCH_OFFICE + " TEXT , " + MESSAGE_PHONENO + " TEXT , "+ MESSAGE_OTP + " INTEGER , "+ "PRIMARY KEY("  + MESSAGE_ID + "), " +"FOREIGN KEY(" + MESSAGE_CUS_ID + ") REFERENCES " + CUSTOMER_TABLE + "(" + CUSTOMER_ID + "),"+ "FOREIGN KEY(" + MESSAGE_PROF_ID + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + "))";
