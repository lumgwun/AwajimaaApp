...
public class BorrowingAdapter extends RecyclerView.Adapter<BorrowingAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        holder.bank.setText(String.valueOf(recyclerData.getLoanBank()));
        holder.name.setText(String.valueOf(recyclerData.getLoanAcctName()));
        holder.status.setText(String.valueOf(recyclerData.getLoan_status()));
        holder.acctNo.setText(String.valueOf(recyclerData.getLoanBankAcctNo()));
        holder.acctBalance.setText(String.valueOf(recyclerData.getLoanBalance()));
