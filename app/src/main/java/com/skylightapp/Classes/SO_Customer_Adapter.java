...
public class SO_Customer_Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        profile=standingOrder.getSo_Profile();
        ...
        long accountNo = (long) standingOrder.getSo_Account().getSkyLightAcctNo();
        ...
        holder.soExpectedAmount.setText(MessageFormat.format("Expected Amount: {0}", standingOrders.get(position).getSo_ExpectedAmount()));
        holder.soReceivedAmount.setText(MessageFormat.format("SO Received Amount: {0}", standingOrders.get(position).getSo_ReceivedAmount()));
        ...
        holder.soAmountDiff.setText(MessageFormat.format("SO Amount Remaining: {0}", standingOrders.get(position).getSo_AmountDiff()));
