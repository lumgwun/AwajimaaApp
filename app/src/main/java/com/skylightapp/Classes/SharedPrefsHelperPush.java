...
public class SharedPrefsHelperPush {
    ...
    private static SharedPrefsHelperPush instance;

    private SharedPreferences sharedPreferences;

    public static synchronized SharedPrefsHelperPush getInstance() {
        if (instance == null) {
            instance = new SharedPrefsHelperPush();
        }
        return instance;
    }

    private SharedPrefsHelperPush() {
        instance = this;
