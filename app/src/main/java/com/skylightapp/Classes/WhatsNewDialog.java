...
public class WhatsNewDialog {
    ...
    private String parseDate(final String dateString) {
        ...
        try {
            ...
            return DateFormat.getDateFormat(mContext).format(Objects.requireNonNull(parsedDate));
    ...
    // webview
    private String getHTMLChangelog(final Resources resources, final String version) {
        ...
        final XmlResourceParser xml = resources.getXml(R.xml.changelog);
        try {
