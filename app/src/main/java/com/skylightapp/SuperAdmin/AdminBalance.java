...
public class AdminBalance extends Account {
    ...
    public static final String CREATE_ADMIN_BALANCE_TABLE = "CREATE TABLE " + ADMIN_BALANCE_TABLE + " (" + ADMIN_BALANCE_NO + " INTEGER, " + ADMIN_BALANCE_PROFILE_ID + " INTEGER, " + ADMIN_BALANCE_CUS_ID + " INTEGER, " + ADMIN_BALANCE_PACKID + " INTEGER, " + ADMIN_EXPECTED_BALANCE + " INTEGER, " +
            ADMIN_RECEIVED_AMOUNT + " INTEGER, " + ADMIN_BALANCE_DATE + " TEXT , " + ADMIN_BALANCE_STATUS + " TEXT, " +
