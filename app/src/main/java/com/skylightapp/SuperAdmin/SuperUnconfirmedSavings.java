...
public class SuperUnconfirmedSavings extends AppCompatActivity implements SavingsAdapter.OnItemsClickListener{
    ...
    String SharedPrefUserPassword,noOfDays, tellerMachine,status,stringNoOfSavings,office, customerPhoneNo,officeBranch,dateOfReport,nameOfCustomer, cmFirstName,cmLastName,cmName,SharedPrefUserMachine,phoneNo,SharedPrefUserName,SharedPrefProfileID,adminName;
