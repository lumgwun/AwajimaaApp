...
public class AdminSupportAct extends AppCompatActivity implements  MessageAdapter.OnItemsClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MessageAdapter(AdminSupportAct.this, this.messages);
    ...
    static class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.purposeOfMessage.setText(MessageFormat.format("Support Type:{0}", message.getSupportType()));
            holder.message.setText(MessageFormat.format("Message:{0}", message.getText()));
            holder.sender.setText(MessageFormat.format("Sender:{0}", message.getSender()));
            holder.message_time.setText(MessageFormat.format("Time:{0}", message.getTimestamp()));
