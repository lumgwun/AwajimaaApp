...
public class LoanApprovalAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(loan !=null) {
            ...
            userProfile = loan.getProfile();
            profileID = userProfile.getPID();
            initialAcctBalance = loan.getAccount().getAccountBalance();
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                   ...
                   String response = transfers.doTransfer(transferPayload);
                    ...
                    userProfile.addTransaction(transactionID,surName,firstName,customerPhone,loanAmt, String.valueOf(loanAcctID),acctDetails,paymentDate,"Loan Disbursement");
