...
public class UpdateGrpAcct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle !=null){
            ...
            txtTittle.setText(MessageFormat.format("Grp Tittle:{0}", groupAccount.getTittle()));
            txtPurpose.setText(MessageFormat.format("Grp Purpose:{0}", groupAccount.getPurpose()));
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                details=managerName+""+"updated some details of group Acct."+groupAccount.getGrpAccountNo();
