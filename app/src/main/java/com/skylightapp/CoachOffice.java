...
public class CoachOffice extends TabActivity {
    private static final String PREF_NAME = "awajima";
    public static final String KEY = "CoachOffice.KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_coach_office);
        ...
        chipNavigationBar.setOnItemSelectedListener
                (new ChipNavigationBar.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(int i) {
                        ...
                        switch (i){
                            case R.id.cHome:
                                Intent myIntent = new Intent(CoachOffice.this, NewCustomerDrawer.class);
                            ...
                            case R.id.cTimeLine:
                                ...
                                Intent chat = new Intent(CoachOffice.this, MyTimelineAct.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.cGeneralShop:
                                ...
                                Intent shop = new Intent(CoachOffice.this, MarketTab.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.cPackageT:
                                ...
                                Intent pIntent = new Intent(CoachOffice.this, PackListTab.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.cSupport:
                                Intent helpIntent = new Intent(CoachOffice.this, CustomerHelpActTab.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
