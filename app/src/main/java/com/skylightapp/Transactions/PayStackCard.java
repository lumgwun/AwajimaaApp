...
public class PayStackCard extends co.paystack.android.model.Card implements Serializable {
    ...
    /*public PayStackCard(@NotNull Builder builder) {
        this(builder);
        //super(builder);
    ...
    /*public PayStackCard(String number, Integer expiryMonth, Integer expiryYear, String cvc, String name,
        ...
        super(number,expiryMonth,expiryYear,cvc,name,addressLine1,addressLine2,addressLine3,addressLine4,addressCountry,addressPostalCode,country);
        //super(number);
    ...
    public PayStackCard(String number, Integer expiryMonth, Integer expiryYear, String cvc) {
        this(number, expiryMonth, expiryYear, cvc, null, null, null, null,
                null, null, null);
    }

    public PayStackCard(String number, Integer expiryMonth, Integer expiryYear, String cvc, String name, String addressLine1, String addressLine2, String addressLine3, String addressLine4, String addressCountry, String addressPostalCode, Object o) {
        super(number, expiryMonth, expiryYear, cvc, name, addressLine1, addressLine2, addressLine3, addressLine4, addressCountry, addressPostalCode, "o");
    }

    public PayStackCard(String number, Integer expiryMonth, Integer expiryYear, String cvc, String name, String addressLine1, String addressLine2, String addressLine3, String addressLine4, String addressCountry, String addressPostalCode, String country) {
        super(number, expiryMonth, expiryYear, cvc, name, addressLine1, addressLine2, addressLine3, addressLine4, addressCountry, addressPostalCode, country);
    }
    ...
    /**
     * Validates the PayStackCard object
     *
     ...
     */
    public static class Builder extends co.paystack.android.model.Card.Builder {
        private String name;
        private String number;
        private String cvc;
        private Integer expiryMonth;
