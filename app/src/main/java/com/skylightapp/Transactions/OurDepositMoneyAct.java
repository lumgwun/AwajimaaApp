...
import com.skylightapp.Markets.CardDepositActivity;
...
public class OurDepositMoneyAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setItems(new CharSequence[]
                        {"Through Direct Bank Payment", "Through PayStackCard","Through Bank Transfer","Through Mobile Money","Through UK Bank","Through Google Pay","Through QuickTeller"},
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                Toast.makeText(getApplicationContext(), "Bank transfer option selected", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(getApplicationContext(), AwajimaBTransferAct.class);
                                ...
                                break;
                            case 1:
                                Toast.makeText(getApplicationContext(), "PayStackCard Option selected", Toast.LENGTH_SHORT).show();
