...
public class SkylightPayInitializer {
    ...
    public SkylightPayInitializer(String email, double amount, String publicKey,
        ...
        //else this.orderedPaymentTypesList.add(Utils.PAYMENT_TYPE_CARD);
    }
    public SkylightPayInitializer() {
    }
