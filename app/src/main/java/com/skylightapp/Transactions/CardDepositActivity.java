...
public class CardDepositActivity extends AppCompatActivity {
    ...
    private void startAFreshCharge(boolean local) {
        ...
        if (local) {
            ...
            try {
                charge.putCustomField("Charged From", "Skylight Mobile App");
    ...
    private void chargeCard() {
        transaction = null;
        String depositText="Your Deposit of N"+depositAmount+"into your Skylight acct"+accountNo+"was successful";
        String depositTextFailed="Your Deposit of N"+depositAmount+"into your Skylight acct"+accountNo+"failed";
