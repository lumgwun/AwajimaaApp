...
public class EmergResponse implements Parcelable, Serializable {
    ...
    public static final String CREATE_RESPONSE_TABLE = "CREATE TABLE " + RESPONSE_TABLE + " (" + RESPONSE_DB_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + RESPONDER_EMERG_ID + " INTEGER, " + RESPONDER_PROF_ID + " INTEGER, " + RESPONDER_DEVICE_ID + " TEXT, " + RESPONSE_START_TIME + " TEXT, " + RESPONSE_END_TIME + " TEXT, " + RESPONDER_ORIGIN + " TEXT, " +
