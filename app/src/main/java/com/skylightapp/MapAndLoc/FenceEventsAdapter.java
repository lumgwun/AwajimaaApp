...
public class FenceEventsAdapter extends RecyclerView.Adapter<FenceEventsAdapter.EventViewHolder> {
    ...
    class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        private final String CLASSTAG =
                " " + FenceEventsAdapter.class.getSimpleName () + "." +
                        FenceEventsAdapter.EventViewHolder.class.getSimpleName () + " ";
    ...
    FenceEventsAdapter(@NotNull AppController theApp)
    {
        app = theApp;
    ...
    public FenceEventsAdapter(Context context, ArrayList<FenceEvent> fenceEvents) {
    ...
    @Override
    public void onBindViewHolder (@NonNull FenceEventsAdapter.EventViewHolder holder, int position) {
    ...
    @NonNull
    @Override
    public FenceEventsAdapter.EventViewHolder onCreateViewHolder (@NonNull ViewGroup parent,
                                                                 int viewType ) {
        Log.v (AwajimaLog.LOGTAG, CLASSTAG + "onCreateViewHolder called");
        View view = LayoutInflater.from (parent.getContext ())
                .inflate (R.layout.fence_event, parent, false);
        return new FenceEventsAdapter.EventViewHolder(view);
    }
