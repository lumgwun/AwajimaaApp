...
import com.webgeoservices.woosmapgeofencingcore.LoadedVisit;
import com.webgeoservices.woosmapgeofencingcore.SphericalMercator;
import com.webgeoservices.woosmapgeofencingcore.ZOIQualifiers;
...
public class VisitsCreator {
    ...
    public VisitsCreator(Context mContext) {
        this.context = mContext;
    }
    public VisitsCreator() {

    }
    public void figmmForVisit(Visit visit) {
        if (OtherPref.creationOfZOIEnable) {
            visit_m = visit;
            figmmAlgo( visit.getLat(), visit.getLng(), visit.getAccuracy(), visit.getUuid(), visit.getStartTime(), visit.getEndTime() );
        }
    }

    public void figmmForVisitTest(Visit visit) {
        visit_m = visit;
        figmmAlgoTest(visit.getLat(), visit.getLng(), visit.getAccuracy(), visit.getUuid(), visit.getStartTime(), visit.getEndTime());
    }
