...
public class PlacesAutoCAdapter extends ArrayAdapter<String> implements Filterable
{
    ...
    private static final String API_KEY = MAP_API;
    private static final String TAG = "CameraModule";

    private ArrayList<String> resultList;

    public PlacesAutoCAdapter(Context context, int textViewResourceId) {
