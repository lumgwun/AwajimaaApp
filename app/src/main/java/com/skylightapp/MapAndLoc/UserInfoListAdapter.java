...
import com.skylightapp.StateDir.GeocodeConstants;
...
public class UserInfoListAdapter extends ArrayAdapter<UserInfoList> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent){
        ...
        if(listItem == null)
            listItem = LayoutInflater.from(mContext).inflate(R.layout.userinfo_item,parent,false);
        ...
        AppCompatTextView userNamefirstLetter = listItem.findViewById(R.id.username_firstLetter);
        ...
        // User name
        AppCompatTextView userName = listItem.findViewById(R.id.textview_name);
        userName.setText(currentUser.getName());
        Log.v(GeocodeConstants.TAG_MAIN,"name:" + currentUser.getName());


        // User address
        AppCompatTextView userAdd = listItem.findViewById(R.id.textView_address);
        ...
        AppCompatTextView userLat = listItem.findViewById(R.id.textView_latitude);
        userLat.setText(formatCoordinates(currentUser.getAddress_latitude()));

        // Longitude of the user's address
        AppCompatTextView userLong = listItem.findViewById(R.id.textView_longitude);
