...
public class PlaceContentProvider extends ContentProvider {
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case PLACES:
                ...
                long id = db.insert(PLACE_ENTRY_TABLE, null, values);
                if (id > 0) {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            ...
            case PLACES:
                retCursor = db.query(PLACE_ENTRY_TABLE,
                        projection,
                        selection,
                        selectionArgs,
                        null,
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case PLACE_WITH_ID:
                ...
                placesDeleted = db.delete(PLACE_ENTRY_TABLE, "_id=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            case PLACE_WITH_ID:
                ...
                String id = uri.getPathSegments().get(1);
                // Use selections/selectionArgs to filter for this ID
                placesUpdated = db.update(PLACE_ENTRY_TABLE, values, "_id=?", new String[]{id});
                break;
            // Default exception
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
