...
public class GeofenceAct extends AppCompatActivity {
    ...
    private void loadPOI() {
        final LiveData<POI[]> POIList = WoosmapDb.getInstance(GeofenceAct.this).getPOIsDAO().getAllLivePOIs();
    ...
    private void loadVisit() {
        final LiveData<Visit[]> VisitList = WoosmapDb.getInstance(GeofenceAct.this).getVisitsDao().getAllLiveStaticPositions();
    ...
    private void loadRegion() {
        final LiveData<Region[]> regionList = WoosmapDb.getInstance( GeofenceAct.this ).getRegionsDAO().getAllLiveRegions();
        regionList.observe( this, new Observer<Region[]>() {
            ...
            public void onChanged(Region[] regions) {
                ...
                for (Region region : regions) {
                    GeofenceAct.this.mapFragment.regions.add(region);
                }
    ...
    private void loadZOI() {
        ...
        final LiveData<ZOI[]> zoiList = WoosmapDb.getInstance( GeofenceAct.this ).getZOIsDAO().getAllLiveZois();
        zoiList.observe( this, new Observer<ZOI[]>() {
            ...
            public void onChanged(ZOI[] zois) {
                ...
                GeofenceAct.this.mapFragment.zois.addAll(Arrays.asList(zois));
    ...
    private void loadRegionLogs() {
        final LiveData<RegionLog[]> regionLogList = WoosmapDb.getInstance( GeofenceAct.this ).getRegionLogsDAO().getAllLiveRegionLogs();
    ...
    public void loadData() {
        final LiveData<MovingPosition[]> movingPositionList = WoosmapDb.getInstance(GeofenceAct.this).getMovingPositionsDao().getLiveDataMovingPositions(-1);
