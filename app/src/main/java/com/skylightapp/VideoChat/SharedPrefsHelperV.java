...
public class SharedPrefsHelperV {
    ...
    private static SharedPrefsHelperV instance;
    private SharedPreferences sharedPreferences;

    public static synchronized SharedPrefsHelperV getInstance() {
        if (instance == null) {
            instance = new SharedPrefsHelperV();
        }
        return instance;
    }

    private SharedPrefsHelperV() {
        instance = this;
        sharedPreferences = AppV.getInstance().getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE);
    }
