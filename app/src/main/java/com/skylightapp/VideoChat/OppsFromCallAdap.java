...
import com.skylightapp.MarketClasses.QBRTCSessionUtils;
import com.skylightapp.R;

import java.util.List;

public class OppsFromCallAdap extends RecyclerView.Adapter<OppsFromCallAdap.ViewHolder> {

    private static final String TAG = OppsFromCallAdap.class.getSimpleName();
    private final int itemHeight;
    private final int itemWidth;

    private Context context;
    private BaseConversationFragmentV baseConversationFragment;
    private List<QBUser> opponents;
    private LayoutInflater inflater;
    private OnAdapterEventListener adapterListener;

    public OppsFromCallAdap(Context context, BaseConversationFragmentV baseConversationFragment, List<QBUser> users, int width, int height) {
