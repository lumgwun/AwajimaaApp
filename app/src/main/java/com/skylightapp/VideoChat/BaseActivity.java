...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected SharedPrefsHelperV sharedPrefsHelper;
    private ProgressDialog progressDialog;
    protected QBResRequestExecutorV requestExecutor;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //setContentView(R.layout.act_base2);
        actionBar = getSupportActionBar();
        requestExecutor = AppV.getInstance().getQbResRequestExecutor();
        sharedPrefsHelper = SharedPrefsHelperV.getInstance();
    }
