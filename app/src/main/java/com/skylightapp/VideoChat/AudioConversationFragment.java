...
import static com.skylightapp.MarketClasses.ResourceUtils.getString;

public class AudioConversationFragment extends BaseConversationFragmentV implements CallActV.OnChangeAudioDevice {
    ...
    ConversationFragmentCallback conversationFragmentCallback = null;
    ...
    protected void initViews(View view) {
        ...
        timerCallText = view.findViewById(R.id.timer_callV);
        ...
        audioSwitchToggleButton.setChecked(SharedPrefsHelperV.getInstance().get(SPEAKER_ENABLED, true));
    ...
    protected void initButtonsListener() {
        ...
        audioSwitchToggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SharedPrefsHelperV.getInstance().save(SPEAKER_ENABLED, isChecked);
                if (conversationFragmentCallback != null) {
