...
public class VideoConversationFragV extends BaseConversationFragmentV implements Serializable,
        QBRTCClientVideoTracksCallbacks<QBRTCSession>, QBRTCSessionStateCallback<QBRTCSession>,
        QBRTCSessionEventsCallback, OppsFromCallAdap.OnAdapterEventListener {
    private final String TAG = VideoConversationFragV.class.getSimpleName();
    ...
    private SparseArray<OppsFromCallAdap.ViewHolder> opponentViewHolders;
    private OppsFromCallAdap opponentsAdapter;
    ...
    public void onPause() {
        ...
        SharedPrefsHelperV.getInstance().save(IS_CURRENT_CAMERA_FRONT, isCurrentCameraFront);
        super.onPause();
    }
    ...
    protected void initViews(View view) {
        ...
        cameraToggle.setChecked(SharedPrefsHelperV.getInstance().get(CAMERA_ENABLED, true));
        toggleCamera(cameraToggle.isChecked());
        actionVideoButtonsLayout = (LinearLayout) view.findViewById(R.id.element_set_video_buttons);

        isCurrentCameraFront = SharedPrefsHelperV.getInstance().get(IS_CURRENT_CAMERA_FRONT, true);
    ...
    private void setGrid(int columnsCount) {
        ...
        opponentsAdapter = new OppsFromCallAdap(getContext(), this, opponents, cellSizeWidth,
    ...
    private void releaseViews() {
        if (conversationFragmentCallback.getCurrentSessionState() != BaseSession.QBRTCSessionState.QB_RTC_SESSION_CLOSED) {
            Map<Integer, QBRTCVideoTrack> videoTrackMap = ((CallActV) requireActivity()).getVideoTrackMap();
    ...
    protected void initButtonsListener() {
        ...
        cameraToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SharedPrefsHelperV.getInstance().save(CAMERA_ENABLED, isChecked);
        ...
        if (conversationFragmentCallback != null) {
            conversationFragmentCallback.onSwitchCamera(new CameraVideoCapturer.CameraSwitchHandler() {
                ...
                public void onCameraSwitchDone(boolean b) {
                    ...
                    SharedPrefsHelperV.getInstance().save(IS_CURRENT_CAMERA_FRONT, b);
                    if (item != null) {
                        updateSwitchCameraIcon(item);
                    } else {
                        optionsMenu.findItem(R.id.camera_switch).setIcon(R.drawable.ic_camera_rear_fg);
                    }
    ...
    private void updateSwitchCameraIcon(final MenuItem item) {
        if (conversationFragmentCallback.isCameraFront()) {
            ...
            item.setIcon(R.drawable.ic_camera_front_fg);
        } else {
            Log.d(TAG, "CameraRear now!");
            item.setIcon(R.drawable.ic_camera_rear_fg);
        }
    }
    ...
    @Override
    public void OnBindLastViewHolder(final OppsFromCallAdap.ViewHolder holder, final int position) {
    ...
    private void updateViewHolders(int position) {
        ...
        OppsFromCallAdap.ViewHolder childViewHolder = (OppsFromCallAdap.ViewHolder) recyclerView.getChildViewHolder(childView);
    ...
    private void setRemoteViewMultiCall(int userID, QBRTCVideoTrack videoTrack) {
        ...
        final OppsFromCallAdap.ViewHolder itemHolder = getViewHolderForOpponent(userID);
        if (itemHolder == null) {
    ...
    private OppsFromCallAdap.ViewHolder getViewHolderForOpponent(Integer userID) {
        OppsFromCallAdap.ViewHolder holder = opponentViewHolders.get(userID);
        if (holder == null) {
    ...
    private OppsFromCallAdap.ViewHolder findHolder(Integer userID) {
    ...
    private void setStatusForOpponent(int userId, final String status) {
        ...
        final OppsFromCallAdap.ViewHolder holder = findHolder(userId);
        if (holder == null) {
            return;
        }
    ...
    private void updateNameForOpponent(int userId, String newUserName) {
        if (isPeerToPeerCall) {
            ...
            OppsFromCallAdap.ViewHolder holder = findHolder(userId);
            if (holder == null) {
    ...
    private void setProgressBarForOpponentGone(int userId) {
        ...
        final OppsFromCallAdap.ViewHolder holder = getViewHolderForOpponent(userId);
        if (holder == null) {
            return;
        }
    ...
    private void setAnotherUserToFullScreen() {
        ...
        for (int index = 0; index <= opponents.size() - 1; index++) {
            ...
            if (videoTrack != null) {
                ...
                OppsFromCallAdap.ViewHolder itemHolder = findHolder(opponents.get(index).getId());
                if (itemHolder != null) {
