...
import com.skylightapp.MarketClasses.RingtonePlayer;
...
import static com.skylightapp.VideoChat.ConstsV.MAX_OPPONENTS_COUNT;

public class CallServiceV extends Service {
    private static final String TAG = CallServiceV.class.getSimpleName();
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, CallServiceV.class);
    ...
    private Notification initNotification() {
        Intent notifyIntent = new Intent(this, CallActV.class);
    ...
    public void clearButtonsState() {
        SharedPrefsHelperV.getInstance().delete(BaseConversationFragmentV.MIC_ENABLED);
        ...
        SharedPrefsHelperV.getInstance().delete(VideoConversationFragV.IS_CURRENT_CAMERA_FRONT);
    }

    public void clearCallState() {
        SharedPrefsHelperV.getInstance().delete(ConstsV.EXTRA_IS_INCOMING_CALL);
    }
    ...
    public class CallServiceBinder extends Binder {
        public CallServiceV getService() {
            return CallServiceV.this;
        }
    }
    ...
    private class SessionEventsListener implements QBRTCClientSessionCallbacks {
        ...
        public void onSessionStartClose(QBRTCSession session) {
            if (session == WebRtcSessionManager.getInstance(getApplicationContext()).getCurrentSession()) {
                CallServiceV.stop(getApplicationContext());
            }
        }
        ...
        public void onUserNoActions(QBRTCSession qbrtcSession, Integer integer) {
            ...
            CallServiceV.stop(CallServiceV.this);
        }
