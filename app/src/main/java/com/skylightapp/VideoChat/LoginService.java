    ...
    private void sendResultToActivity(boolean isSuccess, String errorMessage) {
        if (pendingIntent != null) {
            ...
            try {
                ...
                intent.putExtra(ConstsV.EXTRA_LOGIN_RESULT, isSuccess);
                intent.putExtra(ConstsV.EXTRA_LOGIN_ERROR_MESSAGE, errorMessage);

                pendingIntent.send(LoginService.this, ConstsV.EXTRA_LOGIN_RESULT_CODE, intent);
                stopForeground(true);
