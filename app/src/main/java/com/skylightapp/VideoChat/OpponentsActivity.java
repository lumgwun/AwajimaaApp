...
public class OpponentsActivity extends BaseActivity {
    ...
    protected void onResume() {
        super.onResume();
        boolean isIncomingCall = SharedPrefsHelperV.getInstance().get(ConstsV.EXTRA_IS_INCOMING_CALL, false);
        if (isCallServiceRunning(CallServiceV.class)) {
            Log.d(TAG, "CallService is running now");
            CallActV.start(this, isIncomingCall);
        }
    ...
    private void startPermissionsActivity(boolean checkOnlyAudio) {
        PermissionsActivity.startActivity(this, checkOnlyAudio, ConstsV.PERMISSIONS);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.start_video_call:
                ...
                if (checker.lacksPermissions(ConstsV.PERMISSIONS)) {
            ...
            case R.id.start_audio_call:
                ...
                if (checker.lacksPermissions(ConstsV.PERMISSIONS[1])) {
    ...
    private void startCall(boolean isVideoCall) {
        ...
        if (usersAdapter.getSelectedUsers().size() > ConstsV.MAX_OPPONENTS_COUNT) {
            ToastUtils.longToast(String.format(getString(R.string.error_max_opponents_count),
                    ConstsV.MAX_OPPONENTS_COUNT));
            return;
        }
