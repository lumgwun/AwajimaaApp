...
public class AwajimaPackAct extends AppCompatActivity implements  NewSkylightPackageSlider.OnItemsClickListener{
    ...
    private ArrayList<MarketBizPackage> recyclerDataArrayList;
    ...
    private void fillPackageList() {
        ...
        skyLightPackage_2s.add(new MarketBizPackModel(R.drawable.hp_16gb_1tb_ssd_608, "HP, 16Gb, 1Tb Laptop", "Gadget Purchase",1110000, "Intel core i7, 16Gb RAM, 1TGb HDD with SSD", 8));
        skyLightPackage_2s.add(new MarketBizPackModel(R.drawable.hp_32gb_2tb_ssd_, "HP 32Gb, 2TB Laptop","Gadget Purchase", 1620000, "Intel core i7, 32Gb RAM, 2TGb HDD with SSD,15 Inches", 8));
    ...
    public class The_slide_timer extends TimerTask {
        ...
        public void run() {
            ...
            AwajimaPackAct.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
    ...
    @Override
    public void onItemClick(MarketBizPackModel lightPackage) {
        ...
        Intent payIntent = new Intent(AwajimaPackAct.this, PayNowActivity.class);
