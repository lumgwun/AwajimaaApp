...
import com.skylightapp.MarketClasses.NoChildClickableRecyclerView;
...
public class ConversationFragment extends BaseToolBarFragment implements CallServiceConf.CurrentCallStateCallback, QBRTCSessionStateCallback<ConferenceSession>,
        QBRTCClientVideoTracksCallbacks<ConferenceSession>, OpponentsFromCallAdapter.OnAdapterEventListener, CallServiceConf.OnlineParticipantsChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getActivity() != null && getActivity().getApplicationContext() != null) {
            ...
            sharedPrefsHelperCon = ((App) getActivity().getApplicationContext()).getSharedPrefsHelper();
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (this.getArguments() != null) {
            opponentsIds = this.getArguments().getIntegerArrayList(ConstsInterface.EXTRA_DIALOG_OCCUPANTS);
        }
        asListenerRole = conversationFragmentCallback.isListenerRole();
        roomTitle = conversationFragmentCallback.getRoomTitle();
        sessionManager = WebRtcSessionManager.getInstance(getContext());
        currentSession = sessionManager.getCurrentSessionC();
        if (currentSession == null) {
    ...
    private void initFields() {
        currentUser = sharedPrefsHelperCon.getQbUser();
        sessionManager = WebRtcSessionManager.getInstance(getContext());
        currentSession = sessionManager.getCurrentSessionC();
