...
public class QBPushSubListenerImplCon implements QBPushManager.QBSubscribeListener {
    private static final String TAG = QBPushSubListenerImplCon.class.getSimpleName();
