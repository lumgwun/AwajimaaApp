...
public class ChatAdapterConf extends RecyclerView.Adapter<ChatAdapterConf.NewMessageViewHolder> implements
    ...
    public ChatAdapterConf(Context context, QBChatDialog chatDialog, List<QBChatMessage> chatMessages) {
    ...
    private void fillTextMessageHolder(NewMessageViewHolder holder, QBChatMessage chatMessage, boolean isIncomingMessage) {
        ...
        String forwardedFromName = (String) chatMessage.getProperty(ChatActCon.PROPERTY_FORWARD_USER_NAME);
    ...
    private void fillAvatarHolder(NewMessageViewHolder holder, QBChatMessage chatMessage) {
        ...
        QBUser user = ((AppConference) context).getQBUsersHolder().getUserById(chatMessage.getSenderId());
    ...
    private void displayAttachment(NewMessageViewHolder holder, int position, QBChatMessage chatMessage) {
        ...
        if (attachment != null) {
            ...
            if (photoType || imageType) {
                ...
                ToastUtilsCon.shortToast(context, "Unknown Attachment Received");
            }
        }
    }
    ...
    private String getSenderName(QBChatMessage chatMessage) {
        QBUser sender = ((AppConference) context).getQBUsersHolder().getUserById(chatMessage.getSenderId());
        String fullName = "";
    ...
    private boolean isReadByCurrentUser(QBChatMessage chatMessage) {
        Integer currentUserId = ((AppConference) context).getChatHelper().getCurrentUser().getId();
    ...
    private boolean isIncoming(QBChatMessage chatMessage) {
        QBUser currentUser = ((AppConference) context).getChatHelper().getCurrentUser();
    ...
    public void setAttachImageClickListener(ChatActCon.ImageAttachClickListener imageAttachClickListener) {
        ...
        public void onClick(View view) {
            ...
            if (holder.llMessageContainer != null && attachment != null) {
                if (ValidationUtils.isAttachmentValid(attachment)) {
                    ...
                    ToastUtilsCon.shortToast(context, context.getString(R.string.error_attachment_corrupted));
                }
            }
        }
