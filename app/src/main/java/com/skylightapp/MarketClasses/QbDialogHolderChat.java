...
public class QbDialogHolderChat {
    private static QbDialogHolderChat instance;
    private Map<String, QBChatDialog> dialogsMap;

    public static synchronized QbDialogHolderChat getInstance() {
        if (instance == null) {
            instance = new QbDialogHolderChat();
        }
        return instance;
    }

    private QbDialogHolderChat() {
