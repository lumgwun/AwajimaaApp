...
import com.skylightapp.MarketDealFrags.ProgressDialogFragment;
...
public class GetFilepathFromUriTaskCon extends BaseAsyncTaskCon<Intent, Void, File> {
    ...
    private OnMediaPickedListener listenerMedia;
    ...
    public GetFilepathFromUriTaskCon(FragmentManager fm, OnImagePickedListener listener, int requestCode) {
        this.fmWeakReference = new WeakReference<>(fm);
        this.listener = listener;
        this.requestCode = requestCode;
    }
    public GetFilepathFromUriTaskCon(Context context, FragmentManager fm, OnMediaPickedListener listener, int requestCode) {
        this.fmWeakReference = new WeakReference<>(fm);
        this.contextWeakReference = new WeakReference<>(context);
        this.listenerMedia = listener;
        this.requestCode = requestCode;
    }
    ...
    public void onResult(File file) {
        hideProgress();
        Log.w(GetFilepathFromUriTaskCon.class.getSimpleName(), "onResult listener = " + listener);
        if (listener != null) {
    ...
    public void onException(Exception e) {
        hideProgress();
        Log.w(GetFilepathFromUriTaskCon.class.getSimpleName(), "onException listener = " + listener);
        if (listener != null) {
