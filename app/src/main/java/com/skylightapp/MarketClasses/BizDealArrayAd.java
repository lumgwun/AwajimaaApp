...
public class BizDealArrayAd extends ArrayAdapter<BusinessDeal> {
    ...
    public BizDealArrayAd(Context context, int resource, ArrayList<BusinessDeal> dealArrayList) {
    ...
    public BizDealArrayAd(FragmentActivity activity, int deal_item, ArrayList<BusinessDeal> accounts) {
