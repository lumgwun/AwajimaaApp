...
public class ValidationUtils {
    ...
    public static boolean isLoginValid(Context context, EditText editText) {
        return isEnteredTextValid(context, editText, R.string.field_name_user_login, ConstsInterface.MAX_LOGIN_LENGTH, true);
    }

    public static boolean isFoolNameValid(Context context, EditText editText) {
        return isEnteredTextValid(context, editText, R.string.field_name_user_fullname, ConstsInterface.MAX_FULLNAME_LENGTH, false);
    }
