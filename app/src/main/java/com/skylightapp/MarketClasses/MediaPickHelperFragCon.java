...
public class MediaPickHelperFragCon extends Fragment {
    ...
    private static final String TAG = MediaPickHelperFragCon.class.getSimpleName();

    private OnMediaPickedListener listener;

    public static MediaPickHelperFragCon start(Fragment fragment, int requestCode) {
    ...
    public static MediaPickHelperFragCon start(FragmentActivity activity, int requestCode) {
        Bundle args = new Bundle();
        args.putInt(ARG_REQUEST_CODE, requestCode);
    ...
    private static MediaPickHelperFragCon start(FragmentManager fm, Bundle args) {
        MediaPickHelperFragCon fragment = (MediaPickHelperFragCon) fm.findFragmentByTag(TAG);
        if (fragment == null) {
            fragment = new MediaPickHelperFragCon();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (isResultFromImagePick(requestCode, resultCode, data)) {
            ...
            if (getActivity().getApplicationContext() != null && getArguments() != null) {
                ...
                new GetFilepathFromUriTaskCon(context, getChildFragmentManager(), listener, getArguments().getInt(ARG_REQUEST_CODE)).execute(data);
            }
        } else {
