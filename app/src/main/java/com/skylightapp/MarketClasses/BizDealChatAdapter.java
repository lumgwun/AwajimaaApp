...
import com.skylightapp.MarketInterfaces.AttachClickListener;
import com.skylightapp.MarketInterfaces.MessageLongClickListener;
...
public class BizDealChatAdapter extends RecyclerView.Adapter<BizDealChatAdapter.NewMessageViewHolder> implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
    private static final String TAG = BizDealChatAdapter.class.getSimpleName();
    ...
    private List<QBChatMessage> list;

    public BizDealChatAdapter(Context context, QBChatDialog chatDialog, List<QBChatMessage> chatMessages) {
    ...
    private void fillTextMessageHolder(NewMessageViewHolder holder, QBChatMessage chatMessage, boolean isIncomingMessage) {
        ...
        String forwardedFromName = (String) chatMessage.getProperty(BizDealComAct.PROPERTY_FORWARD_USER_NAME);
    ...
    private void displayAttachment(NewMessageViewHolder holder, int position, QBChatMessage chatMessage) {
        ...
        if (attachment != null) {
            ...
            if (photoType || imageType) {
                ...
                holder.tvVideoFileSize.setText(Formatter.formatShortFileSize(context, (long) attachment.getSize()));
                ...
                holder.tvFileSize.setText(Formatter.formatShortFileSize(context, (long) attachment.getSize()));
                ...
                com.skylightapp.Classes.ToastUtils.shortToast("Unknown Attachment Received");
            }
        }
    }
