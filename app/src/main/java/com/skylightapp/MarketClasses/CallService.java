...
import com.skylightapp.MarketDealFrags.AudioConversationFragment;
import com.skylightapp.MarketDealFrags.BaseConversationFragment;
import com.skylightapp.MarketDealFrags.VideoConversationFragment;
...
public class CallService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            roomTitle = intent.getStringExtra(ConstsInterface.EXTRA_ROOM_TITLE);
            dialogID = intent.getStringExtra(ConstsInterface.EXTRA_DIALOG_ID);
            opponentsIDsList = (ArrayList<Integer>) intent.getSerializableExtra(ConstsInterface.EXTRA_DIALOG_OCCUPANTS);
            asListenerRole = intent.getBooleanExtra(ConstsInterface.EXTRA_AS_LISTENER, false);
    ...
    private Notification initNotification() {
        Intent notifyIntent = new Intent(this, BizDealComAct.class);
    ...
    private class AudioTrackListener implements QBRTCClientAudioTracksCallback<ConferenceSession> {
        ...
        public void onLocalAudioTrackReceive(ConferenceSession conferenceSession, QBRTCAudioTrack qbrtcAudioTrack) {
            ...
            boolean isMicEnabled = ((AppController) getApplicationContext()).getSharedPrefsHelper().get(Consts.PREF_MIC_ENABLED, true);
    ...
    public void clearCallState() {
        SharedPrefsHelper.getInstance().delete(ConstsInterface.EXTRA_IS_INCOMING_CALL);
    }
    ...
    public interface CurrentCallStateCallback extends BizDealComAct.CurrentCallStateCallback {
        void onCallStarted();
