...
public class MultiSelCommoditySpn extends AppCompatSpinner implements DialogInterface.OnMultiChoiceClickListener {
    ...
    public MultiSelCommoditySpn(Context context) {
    ...
    public MultiSelCommoditySpn(Context context, AttributeSet attrs) {
    ...
    public boolean performClick() {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            itemNames[i] = items.get(i).getCommodityName();
    ...
    public void setSelection(ArrayList<Commodity> selection) {
        ...
        for (Commodity sel : selection) {
            ...
            for (int j = 0; j < items.size(); ++j) {
                ...
                if (items.get(j).getCommodityName().equals(sel.getCommodityName())) {
    ...
    private String buildSelectedItemString() {
        ...
        for (int i = 0; i < items.size(); ++i) {
            ...
            if (selection[i]) {
                ...
                sb.append(items.get(i).getCommodityName());
