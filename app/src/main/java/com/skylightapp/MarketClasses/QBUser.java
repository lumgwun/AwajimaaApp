...
import static com.skylightapp.MarketClasses.UserProfileInfo.USER_PROF_INFO_ID;
import static com.skylightapp.MarketClasses.UserProfileInfo.USER_PROF_INFO_TABLE;
...
public class QBUser extends com.quickblox.users.model.QBUser {
    ...
    public static final String QBUSER_PROF_ID = "qb_prof_id";
    ...
    public static final String CREATE_QB_USER_TABLE = "CREATE TABLE IF NOT EXISTS " + QBUSER_TABLE + " ( " + QBUSER_ID + " INTEGER  , " + QBUSER_DETAILS + " TEXT , " + QBUSER_PROF_ID + " INTEGER  , " +
            QBUSER_UPI_ID + " TEXT, " + "FOREIGN KEY(" + QBUSER_PROF_ID + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + "),"+ "FOREIGN KEY(" + QBUSER_UPI_ID + ") REFERENCES " + USER_PROF_INFO_TABLE + "(" + USER_PROF_INFO_ID + "),"+"PRIMARY KEY(" + QBUSER_ID  + "))";
