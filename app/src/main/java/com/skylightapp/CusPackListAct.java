...
public class CusPackListAct extends AppCompatActivity implements  SuperSkylightPackageAdapter.OnItemsClickListener {
    Long accNoStart = 599999999L ;
    Long accNoCount = 0L;

    List<Customer> customersList;
    ArrayList<MarketBizPackage> packageArrayList;
    private Gson gson;
    private String json;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //array_list.add(new MarketBizPackage(9057l, "Savings", 10000.00, 1000000.00, "23/8/2020", 15, "9/1/12", 20000.00, "Completed"));
        //array_list.add(new MarketBizPackage(9357l, "Savings", 10000.00, 1000000.00, "23/8/2020", 15, "", 20000.00, "in progress"));
        //array_list.add(new MarketBizPackage(9051l, "Savings", 10000.00, 1000000.00, "23/8/2020", 15, "", 20000.00, "in progress"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                MarketBizPackage marketBizPackage = packageArrayList.get(position);
                ...
                if(marketBizPackage !=null){
                    ...
                    if(amountContributedSoFar==grandTotal && status.equalsIgnoreCase("unpaid")){
                        ...
                        Toast.makeText(CusPackListAct.this, "packageType Package, selected", Toast.LENGTH_SHORT).show();
                        Intent savingsIntent = new Intent(CusPackListAct.this, RequestPaymentAct.class);
                    ...
                    if(amountContributedSoFar<grandTotal && status.equalsIgnoreCase("inComplete")){
                        AlertDialog.Builder builder = new AlertDialog.Builder(CusPackListAct.this);
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        switch (which) {
                                            ...
                                            case 0:
                                                ...
                                                paymentBundle.putParcelable("MarketBizPackage", marketBizPackage);
                                                paymentBundle.putParcelable("Account", account);
                                                Intent itemPurchaseIntent = new Intent(CusPackListAct.this, TellerForCusLoanAct.class);
                                            ...
                                            case 1:
                                                ...
                                                paymentBundle.putParcelable("MarketBizPackage", marketBizPackage);
                                                paymentBundle.putParcelable("Account", account);
                                                Toast.makeText(CusPackListAct.this, marketBizPackage +" selected for more savings", Toast.LENGTH_SHORT).show();
                                                Intent promoIntent = new Intent(CusPackListAct.this, PayNowActivity.class);
                        ...
                        if(amountContributedSoFar<grandTotal){
                            ...
                            Intent intent = new Intent(CusPackListAct.this, PayNowActivity.class);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CusPackListAct.this, LoginDirAct.class);
    ...
    public void onItemClick(MarketBizPackage lightPackage) {
        ...
        dataBundle.putParcelable("MarketBizPackage", lightPackage);
        dataBundle.putParcelable("Package", lightPackage);
        Intent intent = new Intent(CusPackListAct.this, CusPackListAct.class);
