...
public class WimpeySavings extends AppCompatActivity implements SavingsAdapter.OnItemsClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManagerC
                = new LinearLayoutManager(WimpeySavings.this, LinearLayoutManager.HORIZONTAL, false);
        recyclerViewTXToday.setLayoutManager(layoutManagerC);
        //recyclerViewTXToday.setHasFixedSize(true);
        transactionAdapter = new SavingsAdapter(WimpeySavings.this, customerDailyReports);
        ...
        btnSearchDB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transactionAdapter = new SavingsAdapter(WimpeySavings.this, customerDailyReportArrayList);
