...
public class TodayBirthdayAdap extends RecyclerView.Adapter<BirthdayViewHolder> {

    private ArrayList<Birthday> birthdays;
    private Context context;


    public TodayBirthdayAdap() {
        birthdays = new ArrayList<>();
    }

    public TodayBirthdayAdap(Context context) {
    ...
    public void onBindViewHolder(final BirthdayViewHolder viewHolder, final int position) {
        ...
        viewHolder.setGender("Gender"+birthday.getProfileGender());
        viewHolder.setOffice("Office"+birthday.getProfileOffice());
        viewHolder.setPhoneNo("Phone No:"+birthday.getProfilePhoneNumber());
