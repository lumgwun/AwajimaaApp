...
import static com.skylightapp.Classes.MyAccountFragment.MANAGE_ADDRESS;
import static com.skylightapp.DeliveryAct.SELECT_ADDRESS;
import static com.skylightapp.MyAddressesAct.refreshItem;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.addresses_item, viewGroup, false);
