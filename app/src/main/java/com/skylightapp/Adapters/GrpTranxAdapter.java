...
public class GrpTranxAdapter extends RecyclerView.Adapter<GrpTranxAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        holder.type.setText("Tranx Type"+transaction.getTranXType());
        holder.date.setText("Date:"+transaction.getTranxDate());
        holder.destinationAcct.setText("Dest. Acct:"+transaction.getTranxDestAcct());
        holder.sendingAcct.setText("Sending Acct:"+transaction.getTranxSendingAcct());
        holder.transID.setText("ID:"+transaction.getTransactionID());
        holder.tranMethod.setText("Method:"+transaction.getTranxMethodOfPay());
        holder.status.setText("Status:"+transaction.getTransactionStatus());
        holder.amount.setText("Amount:"+transaction.getTranxAmount());
    }
