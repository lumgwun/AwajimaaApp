...
import com.skylightapp.Classes.MyOrderItemModel;
import com.skylightapp.Customers.OrderDetailsAct;
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent orderDetailIntent = new Intent(itemView.getContext(), OrderDetailsAct.class);
