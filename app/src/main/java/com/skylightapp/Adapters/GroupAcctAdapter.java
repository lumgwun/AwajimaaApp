...
public class GroupAcctAdapter  extends RecyclerView.Adapter<GroupAcctAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        mainHolder.txtID.setText(MessageFormat.format("Savings ID:{0}", model.getGrpAccountNo()));
        mainHolder.txtTittle.setText(MessageFormat.format("Group Title:N{0}", model.getTittle()));
        mainHolder.txtPurpose.setText(MessageFormat.format("Purpose:{0}", model.getPurpose()));
        mainHolder.txtNames.setText(MessageFormat.format("Name:{0}", model.getLastName()+","+model.getFirstName()));
        mainHolder.txtStartDate.setText(MessageFormat.format("Start Date:{0}", model.getStartDate()));
        mainHolder.txtEndDate.setText(MessageFormat.format("End Date:{0}", model.getEndDate()));
