...
public class TranxAdminA extends RecyclerView.Adapter<TranxAdminA.ViewHolder> implements ListAdapter {
    ...
    public TranxAdminA(Context context, int resource, ArrayList<Transaction> transactions) {
        super();
    ...
    public TranxAdminA(Context context, ArrayList<Transaction> transactions2) {
        this.context = context;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final TextView txtTranxType;
        ...
        public ViewHolder(View view) {
            ...
            txtTranxType = view.findViewById(R.id.txt_transaction_type);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(transaction   !=null){
            holder.txtTranxType.setText(MessageFormat.format("Type: {0}{1}", transaction.getTranXType(), transaction.getTransactionID()));
            ...
            if (transaction.getTranXType() == Transaction.TRANSACTION_TYPE.PAYMENT) {
                ...
                holder.txtTranxType.setText(MessageFormat.format("To Payee: {0}", transaction.getTranxPayee()));
