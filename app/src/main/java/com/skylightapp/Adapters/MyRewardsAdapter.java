            ...
            if(useMiniLayout){
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ProductDetailsAct.couponTitle.setText(title);
                        ProductDetailsAct.couponExpiryDate.setText(validity);
                        ProductDetailsAct.couponTBody.setText(body);
                        ProductDetailsAct.showDialogRecyclerView();
                    }
                });
            }
