...
public class BookingsMainTab extends TabActivity implements NavigationView.OnNavigationItemSelectedListener{
    private static final String PREF_NAME = "awajima";
    public static final String KEY = "BookingsMainTab.KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(BookingsMainTab.this, LoginDirAct.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               /* Intent myIntent = new Intent(BookingsMainTab.this, CustomerHelpActTab.class);
                overridePendingTransition(R.anim.slide_in_right,
                        R.anim.slide_out_left);
                myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                myIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    ...
                    public void onItemSelected(int i) {
                        ...
                        switch (i){
                            ...
                            case R.id.my_boatB:
                                ...
                                Intent chat = new Intent(BookingsMainTab.this, MyBoatAct.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.my_taxiB:
                                ...
                                Intent shop = new Intent(BookingsMainTab.this, MyTaxiAct.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.my_trainB:
                                ...
                                Intent pIntent = new Intent(BookingsMainTab.this, MyTripBAct.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id) {
            case R.id.taxi_nav_tab:
                ...
                Intent intent = new Intent(BookingsMainTab.this, TaxiDriverRideAct.class);
                overridePendingTransition(R.anim.slide_in_right,
                        R.anim.slide_out_left);
            ...
            case R.id.nav_live_tab:
                Intent emergencyIntentSper = new Intent(BookingsMainTab.this, CusMessageAct.class);
                overridePendingTransition(R.anim.slide_in_right,
                        R.anim.slide_out_left);
            ...
            case R.id.nav_tour:
                Intent tourIntent = new Intent(BookingsMainTab.this, TourBookingAct.class);
                overridePendingTransition(R.anim.slide_in_right,
                        R.anim.slide_out_left);
            ...
            case R.id.n_logSettings:
                ...
                editor.clear();
                editor.apply();
                Intent loginIntent = new Intent(BookingsMainTab.this, SignTabMainActivity.class);
