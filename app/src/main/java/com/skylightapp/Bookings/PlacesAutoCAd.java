...
import static com.skylightapp.Bookings.BookingConstant.TYPE_AUTOCOMPLETE;
...
public class PlacesAutoCAd  extends ArrayAdapter<String> implements
        Filterable {
    public static final String LOG_TAG = "UBER";
    private ArrayList<String> resultList = new ArrayList<String>();;

    public PlacesAutoCAd(Context context, int textViewResourceId) {
