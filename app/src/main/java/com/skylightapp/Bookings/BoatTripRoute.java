...
public class BoatTripRoute {
    ...
    public BoatTripRoute(int routeID, String to, String from, String through, String status) {
        super();
    ...
    public BoatTripRoute(int routeId, String to, String from, String through, String state, String status) {
        this.btRouteID = routeId;
        this.btRouteTo = to;
        this.btRouteFrom = from;
        this.btRouteThrough = through;
    ...
    public BoatTripRoute(int routeId, String to, String from, String through, String state, String country, String status) {
        this.btRouteID = routeId;
        this.btRouteTo = to;
        this.btRouteFrom = from;
        this.btRouteThrough = through;
