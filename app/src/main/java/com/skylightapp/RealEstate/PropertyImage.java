...
public class PropertyImage extends  Properties{
    ...
    public static final String CREATE_PROPERTY_PICTURE_TABLE = "CREATE TABLE IF NOT EXISTS " + PROPERTY_PICTURE_TABLE + " (" + PROPERTY_PICTURE_ID + " LONG, " + PROPERTY_ID + " LONG , " +PROFILE_ID + " LONG , " +
            PROPERTY_PICTURE   +  " BLOB, " + PROPERTY_PICTURE_TITTLE + " TEXT, " + PROPERTY_PICTURE_STATUS + " TEXT, " + "PRIMARY KEY(" +PROPERTY_PICTURE_ID+"), " +"FOREIGN KEY(" + PROPERTY_ID  + ") REFERENCES " + PROPERTY_TABLE + "(" + PROPERTY_ID + ")," +"FOREIGN KEY(" + PROFILE_ID + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + "))";
