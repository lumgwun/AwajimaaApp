...
public class OrgRegActivity extends AppCompatActivity {
    ...
    private void doBizReg(){
        ...
        if(TextUtils.isEmpty(ComName)||TextUtils.isEmpty(comPhoneNo)||TextUtils.isEmpty(String.valueOf(comAddress))||TextUtils.isEmpty(comEmail)||TextUtils.isEmpty(selectedLGA)){
            ...
            userProfile.addBusiness(businessID, profileID, ComName,comEmail,comAddress,comPhoneNo, selectedOrgType, comRegNo,joinedDate,"Pending");
            ...
            if(account !=null){
                ...
                business.addAccount("Biz Account",brandName,bizAcctID,0.00,accountTypes);
            ...
            try {
                ...
                userProfile.addTimeLine(tittleT,timelineDetailsT1);
