...
public class PropertyManager extends Profile implements Parcelable, Serializable {
    ...
    public void setProfile_GroupAcct(GroupAccount profile_GroupAcct) { this.groupAccount = profile_GroupAcct; }
    public SavingsGroup getProfile_SavingsGroup() { return savingsGroup; }
    public void setProfile_SavingsGroup(SavingsGroup profile_SavingsGroup) { this.savingsGroup = profile_SavingsGroup; }
