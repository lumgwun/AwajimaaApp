...
public class Properties implements Parcelable , Serializable {
    ...
    public static final String CREATE_PROPERTY_TABLE = "CREATE TABLE IF NOT EXISTS " + PROPERTY_TABLE + " (" + PROPERTY_ID + " LONG, " + PROFILE_ID + " LONG , " +
            CUSTOMER_ID + " LONG , " + PROPERTY_TITTLE + " TEXT, " +PROPERTY_TYPE_OF_LETTING + " TEXT, " + PROPERTY_DATE + " DATE, " + PROPERTY_WARD + " LONG, " +
            PROPERTY_TOWN +  " TEXT, "+ PROPERTY_STATE + " TEXT, " + " LONG, " + PROPERTY_CAPACITY + " TEXT, " + PROPERTY_LONG + " TEXT, " + PROPERTY_LAT + " TEXT, " + PROPERTY_LOCATION + " TEXT, " + PROPERTY_LGA + " TEXT, " + PROPERTY_AMOUNT + " DOUBLE, " + PROPERTY_PRICE_DURATION + " TEXT, " + PROPERTY_AGENT_FEE + " DOUBLE, " +
            PROPERTY_TYPE + " TEXT, " + PROPERTY_LINK + " TEXT, " + PROPERTY_STATUS + " TEXT, "+ PROPERTY_DESCRIPTION + " TEXT, "+ PROPERTY_COUNTRY + " TEXT, " + PROPERTY_PRICE + " TEXT, " + "PRIMARY KEY(" + PROPERTY_ID + "), " +"FOREIGN KEY(" + PROFILE_ID  + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + ")," +"FOREIGN KEY(" + CUSTOMER_ID + ") REFERENCES " + CUSTOMER_TABLE + "(" + CUSTOMER_ID + "))";
