...
public class MySavingsFragment extends Fragment {
    ...
    private static final String URL = "https://awajima.com/CustomerSavingsList";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        savings.add(new CustomerDailyReport(19091001,"190","Savings", "NGN3000", "Old","Confirmed"));
        ...
        ((CusDocCodeSavingsAct) requireActivity()).showUpButton();
