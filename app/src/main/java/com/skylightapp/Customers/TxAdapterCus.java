...
public class TxAdapterCus extends ArrayAdapter<Transaction> {
    ...
    public View getView (int position, View convertView, @NonNull ViewGroup parent) {
        ...
        CustomerDailyReport customerDailyReport = transaction.getTranxCusDailyReport();
        ...
        txtType.setText(MessageFormat.format("{0} - {1}", "Tx Type:", transaction.getTranXType()));
        ...
        if (transaction.getTranXType() == Transaction.TRANSACTION_TYPE.PAYMENT) {
            ...
            txtTransactionInfo.setText(MessageFormat.format("From: {0} - To: {1}", "Destination Acct:", transaction.getTranxDestAcct()));
