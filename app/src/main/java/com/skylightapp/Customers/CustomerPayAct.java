...
public class CustomerPayAct extends AppCompatActivity {
    ...
    private void saveTransaction( ) {
        ...
        userProfile.addTransaction( transactionId, customerName, "", customerPhoneNo, totalToday, String.valueOf(AccountID),  "",currentDateAndTime, "type");
        ...
        Skylightransaction.setMethodOfPay("Online");
        Skylightransaction.setDate(currentDateAndTime);
        Skylightransaction.setPayer(customerName);
