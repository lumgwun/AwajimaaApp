...
public class MessageInfoActCon extends BaseActCon implements QBMessageStatusListener {
    private static final String TAG = MessageInfoActCon.class.getSimpleName();
    ...
    public static void start(Context context, QBChatMessage chatMessage, String messageInfoType) {
        Intent intent = new Intent(context, MessageInfoActCon.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_mes_info_act_con);
    ...
    private void fillAdapter(ArrayList<QBUser> qbUsers) {
        usersListView.setAdapter(new UsersAdapterCon(this, qbUsers));
        ...
        if (messageInfoType.equals(MESSAGE_INFO_DELIVERED_TO) && dialogID.equals(chatMessage.getDialogId())
            ...
            if (user != null) {
                ...
                QBUsers.getUser(userID).performAsync(new QBEntityCallback<QBUser>() {
                    ...
                    @Override
                    public void onError(QBResponseException e) {
                        ToastUtilsCon.shortToast(MessageInfoActCon.this, e.getMessage());
                        if (e.getMessage() != null) {
                            Log.d(TAG, e.getMessage());
                        }
                    }
