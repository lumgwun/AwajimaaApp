...
public class BizBizDepositAct extends AppCompatActivity {
    Date currentDate;
    ...
    private Spinner spnBusiness, spnDepositOffice;
    ...
    private ArrayList<MarketBusiness> ourBusinesses;
    ...
    int biz_item,acctNo, selectedBizIndex;
    private MarketBusiness selectedBusiness;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtAmounts = findViewById(R.id.adminDepAmt);
        btnConfirmation = findViewById(R.id.confirmSaveD);
        btnConfirmation.setOnClickListener(this::saveBizDeposit);
        picker=(DatePicker)findViewById(R.id.biz_payIn_date);
        spnToFrom = findViewById(R.id.spnSelectHow);
        spnDepositOffice = findViewById(R.id.spinnerOfficeB);
        spnBusiness = findViewById(R.id.spN_Biz_Selection);
        spnDepositTranxType = findViewById(R.id.spnBizTypeOfTx);
        ...
        spnBusiness.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(ourBusinesses !=null){
                    ...
                    try {
                        selectedBusiness = ourBusinesses.get(selectedBizIndex);
    ...
    public void saveBizDeposit(View view) {
    }
    private void processReport(int depositID, AdminUser adminUser, int senderProfileID, String adminName, int bizID, String dateOfReport, Profile userProfile, String selectedBank, ArrayList<AdminBankDeposit> adminDeposits, String selectedTranxType, double amountEntered, int officeBranchID){
        ...
        try {
            for (int i = 0; i < adminDeposits.size(); i++) {
                ...
                if (adminDeposits.get(i).getDepositor().equalsIgnoreCase(adminName)&& date.equalsIgnoreCase(dateOfReport)||adminDeposits.get(i).getDepositBank().equalsIgnoreCase(selectedBank)||adminDeposits.get(i).getDepositOfficeBranch().equalsIgnoreCase(selectedfficeBranch)) {
                    Toast.makeText(BizBizDepositAct.this, "There is a similar Deposit report" , Toast.LENGTH_LONG).show();
                    return;
                    ...
                    if (adminUser != null) {
                        ...
                        startNotification();
                        Toast.makeText(BizBizDepositAct.this, "Report submission was successful" , Toast.LENGTH_LONG).show();
