...
public class SelectUsersActCon extends BaseActCon {
    ...
    public static void startForResult(Activity activity, int code, QBChatDialog dialog) {
        Intent intent = new Intent(activity, SelectUsersActCon.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_select_users_act_con);
    ...
    private void updateDialog() {
        ...
        QBRestChatService.getChatDialogById(qbChatDialog.getDialogId()).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                SelectUsersActCon.this.qbChatDialog = qbChatDialog;
                loadUsersFromDialog();
            }
    ...
    private void loadUsersFromQB(String query) {
        ...
        rules.add(new GenericQueryRule(ChatActCon.ORDER_RULE, ORDER_VALUE_UPDATED_AT));
