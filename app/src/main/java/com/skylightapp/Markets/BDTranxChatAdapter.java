...
public class BDTranxChatAdapter extends RecyclerView.Adapter<BDTranxChatAdapter.MyViewHolder> {
    Context context;
    String user_id;
    ...
    public BDTranxChatAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.tranx_chat_row,parent,false);
        return new BDTranxChatAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BDTranxChatAdapter.MyViewHolder holder, int position) {
        ...
        if (String.valueOf(transaction_sender_id.get(position)).compareTo(user_id) == 0){
            ...
            holder.transaction_amount_text.setTextColor(context.getResources().getColor(R.color.red));
            holder.transactionamountsymbol.setImageDrawable(context.getResources().getDrawable(R.drawable.debit_fg));
            holder.share_icon.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_share));
        }else{
            holder.transaction_amount_text.setText("+ "+String.valueOf(transaction_amount.get(position)));
            holder.transaction_amount_text.setTextColor(context.getResources().getColor(R.color.green));
            holder.transction.setLayoutParams(params);
            holder.transactionamountsymbol.setImageDrawable(context.getResources().getDrawable(R.drawable.credit_fg));
            holder.share_icon.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_share));
        }
