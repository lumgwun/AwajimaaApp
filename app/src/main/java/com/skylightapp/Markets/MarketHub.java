...
public class MarketHub extends AppCompatActivity implements MarketAdapter.OnMarketItemsClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Greenmarket Square Market", "Mixed Market ","","South Africa "));
        marketArrayList.add(new Market(R.drawable.market44, "Addis Merkato", "Mixed Market ","","Ethiopia "));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Ariaria Market", "Fabic Market","Aba","Abia State"));
        marketArrayList.add(new Market(R.drawable.market44, "Oil mill Market", "Mixed Market","Phalga","Rivers State"));
        marketArrayList.add(new Market(R.drawable.market44, "Bush Market", "Food Items Market","Etche","Rivers State"));
        marketArrayList.add(new Market(R.drawable.market44, "Wuse Market", "Mixed Market","Phalga","Abuja, FCT"));
        marketArrayList.add(new Market(R.drawable.market44, "Nyanya Market", "General Market","Phalga","Abuja, FCT"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Mararaba Market", "Mixed Market","","FCT"));
        marketArrayList.add(new Market(R.drawable.ic_coll, "Nkwo Nnewi Market", "Mixed Market","Nnewi","Anambra"));
        marketArrayList.add(new Market(R.drawable.market44, "Jos Main Market", "Mixed Market","Plateau","Plateau"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Ogbete Main Market", "Mixed Market","Enugu","Enugu"));
        marketArrayList.add(new Market(R.drawable.market44, "Kasuwar Kwari Market", "Mixed Market","Kano","Kano"));
        marketArrayList.add(new Market(R.drawable.market44, "Kaduna Central Market", "Mixed Market","","Kaduna"));
        marketArrayList.add(new Market(R.drawable.oyo_state, "Gbagi Market", "Mixed Market","Ibadan","Oyo"));
        marketArrayList.add(new Market(R.drawable.market44, "Nchia Market", "Mixed Market","Eleme","Rivers"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Nkwo Nnewi Market", "Mixed Market","","Anambra"));
        marketArrayList.add(new Market(R.drawable.market44, "Maitama Market", "Farmer Market","","Abuja, FCT"));
        marketArrayList.add(new Market(R.drawable.fish14, "Oluwo Market", "Fish Market","","Lagos"));
        marketArrayList.add(new Market(R.drawable.market44, "Mile 1 Market", "Clothes Market","Phalga","Rivers"));
        marketArrayList.add(new Market(R.drawable.market44, "New Market", "Mixed Market","Aba","Abia"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Mile 12 Market", "Mixed Market","","Lagos"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Wuse Market", "Mixed Market","FCT","Abuja"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Garatu Market", "Yam Market","Minna","Niger State"));
        marketArrayList.add(new Market(R.drawable.market44, "Serikin Pawa Market", "Mixed Market","Phalga","Abuja, FCT"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Beji Market", "Mixed Market","","Abuja"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Ete Market", "Mixed Market","Ete","Akwa-Ibom"));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Fruit Garden Market", "Fruits Market","Port Harcourt","Rivers State"));
        marketArrayList.add(new Market(R.drawable.market44, "Mile 3 Market", "Mixed Market ","Khana LGA","Rivers State "));

        marketArrayList.add(new Market(R.drawable.market44, "Jankarra Market", "Mixed Market ","","Lagos State "));
        marketArrayList.add(new Market(R.drawable.market44, "Lekki Market", "Mixed Market ","","Lagos State "));
        marketArrayList.add(new Market(R.drawable.market44, "Agboju Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Daleko Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Mushin Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Oniru Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Fespar Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Rauf Aregbesola Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Téjúoshó Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Sangotedo Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Ajuwe Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Jakande Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Akodo Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.fish14, "Boundary Seafood Market", "Seafood Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Apongbo Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.fish14, "Liverpool Crayfish Market", "Crayfish Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Arena Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Cele Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Ijesha Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "State Market", "Mixed Market ",""," "));
        ...
        marketArrayList.add(new Market(R.drawable.market44, "Plaintain Market", "Plaintain Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Ladipo Paper Market", "Paper Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Aswani Market", "Mixed Market ",""," "));
        marketArrayList.add(new Market(R.drawable.market44, "Leather Market", "Mixed Market ",""," "));

        marketArrayList.add(new Market(R.drawable.market44, "Khan el-Khalili Market", "mixed Market ","","Egypt "));
        marketArrayList.add(new Market(R.drawable.market44, "Kejetia Market", "Mixed Market ","","Ghana "));
        marketArrayList.add(new Market(R.drawable.market44, "Maasai Market", "Mixed Market ","","Kenya "));
        marketArrayList.add(new Market(R.drawable.market44, "Owino Market", "Mixed Market ","","Uganda "));
        marketArrayList.add(new Market(R.drawable.market44, "Maasai Market", "Mixed Market ","","Kenya "));
        marketArrayList.add(new Market(R.drawable.market44, "Fourways Farmers Market", "Farm Market ","","South Africa "));
