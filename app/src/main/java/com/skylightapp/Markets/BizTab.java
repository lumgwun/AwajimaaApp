...
public class BizTab extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BizTab.this, BizDepositTab.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BizTab.this, BizDealCreatorAct.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                //intent.putExtra("PROFILE_ID", profileID);
                Toast.makeText(BizTab.this, "Taking you to the Dashboard", Toast.LENGTH_LONG).show();
                startActivity(intent);
        ...
        Intent intentsupport = new Intent().setClass(this, AdminPackageAct.class);
                    ...
                    public void onItemSelected(int i) {
                        ...
                        switch (i){
                            case R.id.mHome_history:
                                Intent myIntent = new Intent(BizTab.this, MarketAdminOffice.class);
                            ...
                            case R.id.mDeposit_Tab:
                                Intent chat = new Intent(BizTab.this, BizDepositTab.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.market_history:
                                ...
                                Intent shop = new Intent(BizTab.this, MarketTab.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.ma_stocks_H:
                                ...
                                Intent pIntent = new Intent(BizTab.this, StocksTab.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
                            ...
                            case R.id.m_history_M:
                                Intent helpIntent = new Intent(BizTab.this, MarketMessagingTab.class);
                                overridePendingTransition(R.anim.slide_in_right,
                                        R.anim.slide_out_left);
