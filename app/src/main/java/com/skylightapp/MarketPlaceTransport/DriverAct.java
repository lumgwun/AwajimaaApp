...
public class DriverAct extends AppCompatActivity implements OnSuccessListener<Location>{
                ...
                if (isChecked) {
                    ...
                    Teliver.setTripListener(new TripListener() {
                        ...
                        public void onTripStarted(Trip tripDetails) {
                            ...
                            txtSendPush.setTextColor(ContextCompat.getColor(DriverAct.this, R.color.black));
                            edtPushMessage.setEnabled(true);
                            edtPushMessage.setHintTextColor(ContextCompat.getColor(DriverAct.this, R.color.white_good));
                        }
                    ...
                    Teliver.setTripListener(new TripListener() {
                        ...
                        public void onTripEnded(String trackingID) {
                            ...
                            txtSendPush.setTextColor(ContextCompat.getColor(DriverAct.this, R.color.White));
                            edtPushMessage.setText("");
                            edtPushMessage.setHintTextColor(ContextCompat.getColor(DriverAct.this, R.color.White));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 3 && resultCode == RESULT_OK)
            Toast.makeText(DriverAct.this, "Gps is turned on", Toast.LENGTH_SHORT).show();
